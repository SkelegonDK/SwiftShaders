# Diagnose and decide the fix for Ink
...
User-reported (2026-08-26): the **Ink** entry (`sketchInk`) is broken or its
example fails to show the effect. Same sketch family — check for the shared resolution-scaling pattern. Determine which defect class this is —
