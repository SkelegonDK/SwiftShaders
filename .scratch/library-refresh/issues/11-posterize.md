# Diagnose and decide the fix for Posterize
...
User-reported (2026-08-26): the **Posterize** entry (`posterize`) is broken or its
example fails to show the effect. Level reduction may be imperceptible on flat sample colours; check defaults and sample choice. Determine which defect class this is —
