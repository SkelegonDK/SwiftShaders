...
- **GettingStarted.md** is a one-line stub — write it, or delete it and fold into
  the README?
- **API.md** documents only a fraction of the 226 effect methods and is
  hand-maintained — expand it by hand, generate it (from what yardstick — the
  manifest? the coverage ledger?), or replace it with DocC?
