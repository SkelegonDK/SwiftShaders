# Diagnose and decide the fix for Confetti
...
User-reported (2026-08-26): the **Confetti** entry (`confetti`) is broken or its
example fails to show the effect. User-reported: "needs a rework" — treat as a redesign decision for the particle look, not a parameter tweak. Determine which defect class this is —
