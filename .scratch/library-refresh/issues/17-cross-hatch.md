# Diagnose and decide the fix for Cross Hatch
...
User-reported (2026-08-26): the **Cross Hatch** entry (`sketchCrossHatch`) is broken or its
example fails to show the effect. Same sketch family as the sketchCharcoal resolution-scaling bug — check for the shared pattern. Determine which defect class this is —
