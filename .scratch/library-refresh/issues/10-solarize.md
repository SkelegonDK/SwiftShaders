# Diagnose and decide the fix for Solarize
...
User-reported (2026-08-26): the **Solarize** entry (`solarize`) is broken or its
example fails to show the effect. A colour-curve op that may be near-invisible at its default threshold on the default sample. Determine which defect class this is —
