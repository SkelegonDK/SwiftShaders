# Diagnose and decide the fix for Noise
...
User-reported (2026-08-26): the **Noise** entry (`noiseEffect`) is broken or its
example fails to show the effect. Check whether the default mix renders visibly and whether the entry should animate. Determine which defect class this is —
