# Diagnose and decide the fix for Bubbles
...
User-reported (2026-08-26): the **Bubbles** entry (`bubbles`) is broken or its
example fails to show the effect. User-reported: "does not look like bubbles" — the rendering does not read as the named visual; likely needs highlight/rim shading work, not just new defaults. Determine which defect class this is —
