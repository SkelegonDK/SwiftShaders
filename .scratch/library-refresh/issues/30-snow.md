# Diagnose and decide the fix for Snow
...
User-reported (2026-08-26): the **Snow** entry (`snow`) is broken or its
example fails to show the effect. Same specific symptom as Rain: falls upwards; suspect the same y-axis sign flip. Determine which defect class this is —
