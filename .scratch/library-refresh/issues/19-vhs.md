# Diagnose and decide the fix for VHS
...
User-reported (2026-08-26): the **VHS** entry (`vhsGlitch`) is broken or its
example fails to show the effect. A time-driven glitch; check the animated flag and whether the artifacts read at preview scale. Determine which defect class this is —
