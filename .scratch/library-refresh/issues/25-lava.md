# Diagnose and decide the fix for Lava
...
User-reported (2026-08-26): the **Lava** entry (`lavaEffect`) is broken or its
example fails to show the effect. User said "Lava" — assumed to mean this entry rather than Voronoi Lava; verify both while in there. Determine which defect class this is —
