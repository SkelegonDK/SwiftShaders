...
///
/// The `ShaderCatalog` provides a unified interface for accessing and managing
...
/// ```swift
/// Image("photo")
///     .modifier(ShaderCatalog.ripple(time: animationTime))
/// ```
///
/// ## Topics
///
...
public final class ShaderCatalog: Sendable {
    
    // MARK: - Singleton
    
    /// The shared shader library instance.
    public static let shared = ShaderCatalog()
