...
static float rippleDistance(float2 position, float2 origin) {
...
static float rippleWave(float distance, float time, float amplitude, float frequency, float decay, float speed) {
